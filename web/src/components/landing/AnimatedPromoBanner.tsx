...
const PROMO_MESSAGES = [
  {
    ...
    description: 'Be among the first 500 schools to join Young Eagles',
  ...
  },
  {
    ...
    subheadline: '50% OFF First 6 Months',
    description: 'Be among the first 1000 parents to join Young Eagles',
  ...
  },
  {
    ...
    subheadline: '50% OFF First 6 Months',
    description: 'Be among the first 1000 teachers to join Young Eagles',
