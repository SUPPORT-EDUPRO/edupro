-- Fix get_my_trial_status for Community School users
-- Community School (00000000-0000-0000-0000-000000000001) has no subscription record
-- Date: 2025-11-18
...
COMMENT ON FUNCTION get_my_trial_status IS 
  'Returns trial status for current user. Handles Community School (virtual school) users without subscriptions.';
