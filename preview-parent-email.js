...
/**
 * Generate and preview the parent approval email HTML
 * Saves it to a file that you can open in a browser
 */
    ...
    <div style="padding: 30px 20px;">
      ...
      <div style="text-align: center; margin: 30px 0;">
        ...
        <div style="display: inline-block; margin: 0 10px;">
          <p style="margin: 5px 0 0 0; font-size: 12px; color: #999;">📱 Google Play (Coming Soon)</p>
        </div>
        <div style="display: inline-block; margin: 0 10px;">
          <p style="margin: 5px 0 0 0; font-size: 12px; color: #999;">🍎 App Store (Coming Soon)</p>
        </div>
      </div>
...
const emailHtml = generateParentApprovalEmail({
  guardianName: 'King Makunyane',
  studentName: 'Child ONE',
  email: 'dipsroboticsgm@gmail.com',
  schoolName: 'Young Eagles Preschool',
  resetPasswordUrl: 'https://lvvvjywrmpcqrpvuptdi.supabase.co/auth/v1/reset-password',
  pwaUrl: 'https://edudashpro.org.za',
});

const outputPath = path.join(__dirname, 'parent-approval-email-preview.html');
...
console.log('\n📧 Email Details:');
console.log('   To: dipsroboticsgm@gmail.com');
console.log('   Subject: 🎉 Registration Approved - Your EduDash Pro Account is Ready!');
console.log('   Guardian: King Makunyane');
console.log('   Student: Child ONE');
console.log('   School: Young Eagles Preschool');
